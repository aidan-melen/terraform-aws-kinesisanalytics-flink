...
func TestTerraformBasicExample(t *testing.T) {
	...
	outputName   := terraform.Output(t, terraformOptions, "kinesisanalyticsv2_application_name")
	expectedName := "ex-basic"

	assert.Equal(t, expectedName, outputName, "Map %q should match %q", expectedName, outputName)
}
